...
export const INITIAL_NODES: TopicNode[] = [
  ...
  { id: "ag-topico", name: "Tópico Único", subjectId: "s1", parentId: "ag", level: 1, status: "Fraca", metrics: { lastPerformance: 0, questionsSolved: 0 }, metadata: { videoClassStatus: "Pular", questionStatus: "Pendente", reviewStatus: "Não Iniciada", pendencies: [] } },
  ...
  { id: "br-at-grp", name: "Tópico Único", subjectId:"s2" ,parentId:"br" , level :1 , status : "Fraca" , metrics : { lastPerformance : 0 , questionsSolved : 0 } , metadata : { videoClassStatus : "Pular" , questionStatus : "Pendente" , reviewStatus : "Não Iniciada" , pendencies : [] } },
  ...
  { id:"br-div-grp" , name:"Tópico Único" , subjectId:"s2" , parentId:"br" , level :1 , status :"Fraca"  	, metrics:{ lastPerformance : 0	, questionsSolved	:0 }	, metadata:{ videoClassStatus :"Pular"	, questionStatus :"Pendente"	, reviewStatus :"Não Iniciada"	, pendencies		:[ ] } },
